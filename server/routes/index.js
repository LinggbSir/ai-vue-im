...
router.get('/user/photos', authMiddleware, userController.getMediaFiles)
router.get('/user/files', authMiddleware, userController.getFiles)
router.get('/user/message-count', authMiddleware, userController.getMessageCount)
// 联系人相关路由
